...
function color_options(xx) {
  ...
  //Extracting the depth in variable x
  x = xx[2];
...
d3.json(link).then(function (data) {
  ...
  var legend = make_legend()
  legend.addTo(map)
});

var link_2 = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json"
d3.json(link_2).then(function (data) {
